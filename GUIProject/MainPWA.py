...
class Plots(QtWidgets.QWidget):
    ...
    def _create_layouts(self):
        main_layout = QtWidgets.QVBoxLayout()
        main_layout.addLayout(_create_boxes_layout)
        main_layout.addLayout(_create_buttons_layout)
        main_layout.addLayout(_create_test)
        self.setLayout(main_layout)

    def _create_boxes_layout(self):
        layout = QtWidgets.QHBoxLayout()
        layout.addWidget(self.down_options)
        layout.addWidget(self.plotting_graph)
        return layout
